...
const Frame2 = () => {
  ...
  const [extras, setExtras] = useState([
    { name: "병출 추출물", count: 0 },
    { name: "녹차 추출물", count: 0 },
    { name: "달팽이 점액 추출물", count: 0 },
    { name: "꿀 추출물", count: 0 },
    { name: "프로폴리스 추출물", count: 0 },
    { name: "어성초 추출물", count: 0 },
    { name: "인진쑥 추출물", count: 0 },
  ]);
...
다이소듐이디티에이`,
  ...
  const handleExtraItem = () => {
    ...
    const extrasObject = extrasToSave.reduce((obj, extra) => {
      if (extra.count > 0) {
        obj[extra.name] = { count: extra.count };
      }
      return obj;
    }, {});
  ...
  return (
    <View style={styles.view}>
      ...
      <Text style={[styles.text7, styles.textTypo4]}>전성분 확인</Text>
        ...
        <VStack>
                  ...
                  <HStack alignItems={"center"}>
                    ...
                    <Text
                      style={[
                        styles.text2,
                        styles.textTypo,
                        groupvalue.includes(ingredient)
          ...
          <Box ml={8} mr={8} mb={5}>
            <Text style={styles.text2}>
              ※ 선택한 '기능성 추출물'은 배합 후 완성품이 만들어 진 전성분표에
              라벨로 들어갑니다.
            </Text>
          </Box>
          <Pressable
