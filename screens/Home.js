...
import { Center, VStack, Pressable, Box,ScrollView, HStack, Circle, Modal, Divider, Button, IconButton} from "native-base";
...
// 총 금액 계산
const totalPrices = extras.reduce((total, extra) => total + extra.count * 5000, 0);
