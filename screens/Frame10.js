...
import { Circle, VStack,Box, ZStack, Center, Text, Pressable, } from "native-base";
...
const Frame10 = () => {
  ...
  const handleYes = () => {
    ...
    const result = questionsIndexedById[currentQuestionId]?.result || questionsIndexedById[currentQuestionId]?.result1;
